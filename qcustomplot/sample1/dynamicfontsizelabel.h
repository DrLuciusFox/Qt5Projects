...
#ifndef DYNAMICFONTSIZETEXTEDIT_H
#define DYNAMICFONTSIZETEXTEDIT_H

#include <QLabel>
#include <QColor>

class DynamicFontSizeTextBrowser : public QTextBrowser {
    Q_OBJECT

public:
    explicit DynamicFontSizeTextBrowser(QWidget* parent = NULL, Qt::WindowFlags f = Qt::WindowFlags());

    ~DynamicFontSizeTextBrowser() {}
...
#endif // DYNAMICFONTSIZETEXTEDIT_H
